...
TEST_ENCODE_DECODE_CONTAINER(String,  size_4, 1,  str(make_string(4)), {0x84, 0x30, 0x31, 0x32, 0x33})
TEST_ENCODE_DECODE_CONTAINER(String,  size_5, 1,  str(make_string(5)), {0x85, 0x30, 0x31, 0x32, 0x33, 0x34})
TEST_ENCODE_DECODE_CONTAINER(String,  size_6, 1,  str(make_string(6)), {0x86, 0x30, 0x31, 0x32, 0x33, 0x34, 0x35})
TEST_ENCODE_DECODE_CONTAINER(String,  size_7, 1,  str(make_string(7)), {0x87, 0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36})
TEST_ENCODE_DECODE_CONTAINER(String,  size_8, 1,  str(make_string(8)), {0x88, 0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37})
TEST_ENCODE_DECODE_CONTAINER(String,  size_9, 1,  str(make_string(9)), {0x89, 0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38})
TEST_ENCODE_DECODE_CONTAINER(String, size_10, 1, str(make_string(10)), {0x8a, 0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38, 0x39})
TEST_ENCODE_DECODE_CONTAINER(String, size_11, 1, str(make_string(11)), {0x8b, 0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38, 0x39, 0x30})
TEST_ENCODE_DECODE_CONTAINER(String, size_12, 1, str(make_string(12)), {0x8c, 0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38, 0x39, 0x30, 0x31})
TEST_ENCODE_DECODE_CONTAINER(String, size_13, 1, str(make_string(13)), {0x8d, 0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38, 0x39, 0x30, 0x31, 0x32})
TEST_ENCODE_DECODE_CONTAINER(String, size_14, 1, str(make_string(14)), {0x8e, 0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38, 0x39, 0x30, 0x31, 0x32, 0x33})
TEST_ENCODE_DECODE_CONTAINER(String, size_15, 1, str(make_string(15)), {0x8f, 0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38, 0x39, 0x30, 0x31, 0x32, 0x33, 0x34})
TEST_ENCODE_DECODE_CONTAINER(String, size_16, 2, str(make_string(16)), {0x90, 0x40, 0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38, 0x39, 0x30, 0x31, 0x32, 0x33, 0x34, 0x35})
