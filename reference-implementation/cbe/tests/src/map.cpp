...
TEST_DECODE_STATUS(Map, decode_nil_key,  99, 9, true, CBE_DECODE_ERROR_INCORRECT_MAP_KEY_TYPE, {0x94, 0x6f, 0x80, 0x95})
...
TEST_DECODE_STATUS(Map, decode_missing_value_i16,         99, 9, true, CBE_DECODE_ERROR_MAP_MISSING_VALUE_FOR_KEY, {0x94, 0x6b, 0xff, 0x0f, 0x95})
TEST_DECODE_STATUS(Map, decode_missing_value_i32,         99, 9, true, CBE_DECODE_ERROR_MAP_MISSING_VALUE_FOR_KEY, {0x94, 0x6c, 0xff, 0xff, 0xff, 0x0f, 0x95})
TEST_DECODE_STATUS(Map, decode_missing_value_i64,         99, 9, true, CBE_DECODE_ERROR_MAP_MISSING_VALUE_FOR_KEY, {0x94, 0x6d, 0xff, 0xff, 0xff, 0xff, 0x0f, 0x00, 0x00, 0x00, 0x95})
TEST_DECODE_STATUS(Map, decode_missing_value_i128,        99, 9, true, CBE_DECODE_ERROR_MAP_MISSING_VALUE_FOR_KEY, {0x94, 0x6e, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x0f, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x95})
TEST_DECODE_STATUS(Map, decode_missing_value_f32,         99, 9, true, CBE_DECODE_ERROR_MAP_MISSING_VALUE_FOR_KEY, {0x94, 0x72, 0xcd, 0xcc, 0xcc, 0x3d, 0x95})
TEST_DECODE_STATUS(Map, decode_missing_value_f64,         99, 9, true, CBE_DECODE_ERROR_MAP_MISSING_VALUE_FOR_KEY, {0x94, 0x73, 0x51, 0xda, 0x1b, 0x7c, 0x61, 0x32, 0xf0, 0x3f, 0x95})
TEST_DECODE_STATUS(Map, decode_missing_value_f128,        99, 9, true, CBE_DECODE_ERROR_MAP_MISSING_VALUE_FOR_KEY, {0x94, 0x74, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x5e, 0x0c, 0xe5, 0x44, 0xbb, 0x0a, 0x29, 0x03, 0xff, 0x3f, 0x95})
...
TEST_DECODE_STATUS(Map, decode_missing_value_time,        99, 9, true, CBE_DECODE_ERROR_MAP_MISSING_VALUE_FOR_KEY, {0x94, 0x78, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x95})
