...
TEST_ENCODE_DECODE_SHRINKING(Float128, NAME, 0, f128(VALUE),   __VA_ARGS__)

#define TEST_ENCODE_DECODE_SHRINKING_FLOAT64(NAME, VALUE, ...) \
TEST_ENCODE_DECODE_SHRINKING(Float64, NAME, 0, f64(VALUE),   __VA_ARGS__) \
TEST_ENCODE_DECODE_SHRINKING_FLOAT128(NAME, VALUE, __VA_ARGS__)

#define TEST_ENCODE_DECODE_SHRINKING_FLOAT32(NAME, VALUE, ...) \
TEST_ENCODE_DECODE_SHRINKING(Float32, NAME, 0, f32(VALUE),   __VA_ARGS__) \
...
TEST_ENCODE_DECODE_SHRINKING(Bool, false, 0, bl(false), {0x7a})
TEST_ENCODE_DECODE_SHRINKING(Bool, true,  0, bl(true), {0x79})
...
TEST_ENCODE_DECODE_SHRINKING(Decimal64, _1000000_000001, 0, d64(1000000.000001dd), {0x76, 0x01, 0x10, 0xa5, 0xd4, 0xe8, 0x00, 0x00, 0x31})

TEST_ENCODE_DECODE_SHRINKING(Decimal128, _1000000000000_000000000001, 0, d128(1000000000000.000000000001dl), {0x77, 0x01, 0x00, 0x00, 0xa1, 0xed, 0xcc, 0xce, 0x1b, 0xc2, 0xd3, 0x00, 0x00, 0x00, 0x00, 0x28, 0x30})
