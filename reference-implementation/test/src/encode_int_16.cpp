...
DEFINE_ADD_VALUE_TEST(Int16Test, add_101,  (int16_t) 103, {0x67})
DEFINE_ADD_VALUE_TEST(Int16Test, add_n1,   (int16_t)  -1, {0xff})
DEFINE_ADD_VALUE_TEST(Int16Test, add_n101, (int16_t)-103, {0x99})
DEFINE_ADD_VALUE_TEST(Int16Test, add_102,  (int16_t) 104, {TYPE_INT_16, 0x68, 0x00})
DEFINE_ADD_VALUE_TEST(Int16Test, add_n102, (int16_t)-104, {TYPE_INT_16, 0x98, 0xff})
