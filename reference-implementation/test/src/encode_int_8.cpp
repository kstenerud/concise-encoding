...
DEFINE_ADD_VALUE_TEST(Int8Test, add_101,  (int8_t) 103, {0x67})
DEFINE_ADD_VALUE_TEST(Int8Test, add_n1,   (int8_t)  -1, {0xff})
DEFINE_ADD_VALUE_TEST(Int8Test, add_n101, (int8_t)-103, {0x99})
DEFINE_ADD_VALUE_TEST(Int8Test, add_102,  (int8_t) 104, {TYPE_INT_16, 0x68, 0x00})
DEFINE_ADD_VALUE_TEST(Int8Test, add_n102, (int8_t)-104, {TYPE_INT_16, 0x98, 0xff})
