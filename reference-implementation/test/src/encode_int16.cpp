...
DEFINE_SCALAR_WRITE_TEST(Int16Test, add_101,  (int16_t) 101, {0x65})
DEFINE_SCALAR_WRITE_TEST(Int16Test, add_n1,   (int16_t)  -1, {0xff})
DEFINE_SCALAR_WRITE_TEST(Int16Test, add_n101, (int16_t)-101, {0x9b})
DEFINE_SCALAR_WRITE_TEST(Int16Test, add_102,  (int16_t) 102, {TYPE_INT_16, 0x66, 0x00})
DEFINE_SCALAR_WRITE_TEST(Int16Test, add_n102, (int16_t)-102, {TYPE_INT_16, 0x9a, 0xff})
