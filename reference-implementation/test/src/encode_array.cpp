...
DEFINE_ARRAY_WRITE_TEST(NAME, TYPE, 1, {CBE_TYPE, 1}) \
DEFINE_ARRAY_WRITE_TEST(NAME, TYPE, 2, {CBE_TYPE, 2})
...
DEFINE_BOOLEAN_ARRAY_ADD_TEST(size_1, {true}, {TYPE_ARRAY_BOOLEAN, 0x01, 0x01})
DEFINE_BOOLEAN_ARRAY_ADD_TEST(size_2, {true, true}, {TYPE_ARRAY_BOOLEAN, 0x02, 0x03})
DEFINE_BOOLEAN_ARRAY_ADD_TEST(size_3, {true, false, true}, {TYPE_ARRAY_BOOLEAN, 0x03, 0x05})
DEFINE_BOOLEAN_ARRAY_ADD_TEST(size_9, {true, false, true, false, false, true, false, true, true}, {TYPE_ARRAY_BOOLEAN, 0x09, 0xa5, 0x01})
