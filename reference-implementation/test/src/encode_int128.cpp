...
DEFINE_SCALAR_WRITE_TEST(Int128Test, add_101,       (__int128)        101L, {0x65})
DEFINE_SCALAR_WRITE_TEST(Int128Test, add_n1,        (__int128)         -1L, {0xff})
DEFINE_SCALAR_WRITE_TEST(Int128Test, add_n101,      (__int128)       -101L, {0x9b})
DEFINE_SCALAR_WRITE_TEST(Int128Test, add_102,       (__int128)        102L, {TYPE_INT_16, 0x66, 0x00})
DEFINE_SCALAR_WRITE_TEST(Int128Test, add_n102,      (__int128)       -102L, {TYPE_INT_16, 0x9a, 0xff})
