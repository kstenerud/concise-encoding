...
%token TOKEN_TRUE TOKEN_FALSE TOKEN_FLOAT TOKEN_DECIMAL TOKEN_STRING TOKEN_TIME_DD TOKEN_TIME_DDD TOKEN_NIL TOKEN_UNEXPECTED TOKEN_BAD_DATA
...
object:
    ...
    | TOKEN_NIL      { CALL_HANDLER(on_nil,   process); }
    | list
    | map
    | array
    | TOKEN_UNEXPECTED {
