...
template <> cte_encode_status dfp_encoding<_Decimal32>::encode(encoder& encoder)
{
    return encoder.encode(*this);
}

template <> cte_encode_status dfp_encoding<_Decimal64>::encode(encoder& encoder)
{
    return encoder.encode(*this);
}

template <> cte_encode_status dfp_encoding<_Decimal128>::encode(encoder& encoder)
{
    return encoder.encode(*this);
}
