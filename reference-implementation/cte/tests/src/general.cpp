...
TEST_ENCODE_DECODE_SHRINKING(Float128, NAME, 0, f128(VALUE, PRECISION),   __VA_ARGS__)

#define TEST_ENCODE_DECODE_SHRINKING_FLOAT64(NAME, PRECISION, VALUE, ...) \
TEST_ENCODE_DECODE_SHRINKING(Float64, NAME, 0, f64(VALUE, PRECISION),   __VA_ARGS__) \
...
TEST_ENCODE_DECODE_SHRINKING(Float32, NAME, 0, f32(VALUE, PRECISION),   __VA_ARGS__) \
...
// TEST_ENCODE_DECODE_SHRINKING_FLOAT32(_0_0,        5, 0.0,         "0.0")
